...
python3 ASTARTraslados.py ASTAR-tests/mapa_mid3.csv 2
...
python3 ASTARTraslados.py ASTAR-tests/mapa_big2.csv 1
python3 ASTARTraslados.py ASTAR-tests/mapa_extra_big.csv 1
